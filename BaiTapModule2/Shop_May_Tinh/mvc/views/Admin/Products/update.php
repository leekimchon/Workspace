...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="mb-3" style="margin-bottom: 0px !important;">
            ...
            <input name="update_link_anh" value="<?php if(isset($update_link_anh)){echo $update_link_anh;}else{echo $products_old->anh ;}?>"  type="text" class="form-control" id="exampleInput-link-anh">
