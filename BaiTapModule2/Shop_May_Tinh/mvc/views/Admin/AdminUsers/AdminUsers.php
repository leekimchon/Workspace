    ...
    <div class="container-fluid px-4">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="index.php?url=users/index">
                    <button class="nav-link <?php if ($_GET['url'] != 'admin/trash_users') {echo 'active';} ?>" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                    Tất cả
                    </button>
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="index.php?url=users/trash_users">
                    <button class="nav-link <?php if ($_GET['url'] == 'admin/trash_users') { echo 'active';} ?>" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                        Thùng rác
                    </button>
                </a>
            </li>
        ...
        <nav aria-label="Page navigation example" style="float: right;">
            <ul class="pagination">
                ...
                <!-- <li class="page-item active"><a class="page-link" href="index.php?url=users/roles/1">1</a></li>
