                ...
                <form action="{{ route('product.store') }} " method="POST" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input name="price" type="text" class="form-control" id="price" placeholder="nhập tên giá gốc">
                      </div>
                      <div class="form-group">
                        <label for="discount_price">Giá bán</label>
                        <input name="discount_price" type="text" class="form-control" id="discount_price" placeholder="nhập giá bán">
                      </div>
                      <div class="form-group">
